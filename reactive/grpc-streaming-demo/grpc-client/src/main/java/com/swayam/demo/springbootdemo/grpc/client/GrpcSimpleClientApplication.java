package com.swayam.demo.springbootdemo.grpc.client;
...
public class GrpcSimpleClientApplication {

    private static final Logger logger = LoggerFactory.getLogger(GrpcSimpleClientApplication.class);
