...
var requestStream = refreshClickStream.startWith('startup click').map(
		function() {
...
function createSuggestionStream(closeClickStream) {
	return closeClickStream.startWith('startup click').combineLatest(
			responseStream, function(click, listUsers) {
