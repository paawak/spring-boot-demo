...
public class BankDetail implements Serializable
{
    ...
    {
        return "BankDetail [id=" + id + ", age=" + age + ", job=" + job + ", marital=" + marital
                + ", education=" + education + ", defaulted=" + defaulted + ", balance=" + balance
                + ", housing=" + housing + ", loan=" + loan + ", contact=" + contact + ", day="
                + day + ", month=" + month + ", duration=" + duration + ", campaign=" + campaign
                + ", pdays=" + pdays + ", previous=" + previous + ", poutcome=" + poutcome + ", y="
                + y + "]";
    }
